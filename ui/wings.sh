...
main() {
  if [ -d "/etc/pterodactyl" ]; then
    warning "The script has detected that you already have Wings on your system! You cannot run the script multiple times, it will fail!"
...
function goodbye {
  ...
  echo "* Please refer to the Hydrodactyl documentation."
  echo "* "
  ...
  echo "* sudo wings"
  echo "*"
  echo "* Once you have verified that it is working, use CTRL+C and then start Wings as a service"
  echo "*"
